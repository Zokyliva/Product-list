        ...
        this.showAllProduct.innerHTML = product.map(dessert => {
            ...
            <div class="items">
                ...
                ${
                    ...
                    `
                    : `<!-- Mode quantite -->
                    <button class="addCart flex bg-zinc-100 rounded-b-md shadow-lg p-3 border border-zinc-300" data-dessert-id ="${dessert.id}"><svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" fill="none" viewBox="0 0 21 20">
